...
export const PROFILE_ID = import.meta.env.VITE_MULTIPOST_PROFILE_ID || 'd3a25fa0-a0fd-4854-bf4f-ad7b773101ba';
const API_URL = `https://multipost-public.app.infinit.cc/api/public/inventory/profiles/${PROFILE_ID}`;
